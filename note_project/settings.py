...
SECRET_KEY = 'django-insecure-ncd0mb%*3cq2qfoj*z&kr0-k#va0%fe3s*u9x32o3!fsq0c$g='
...
CELERY_BEAT_SCHEDULE = {
    'delete-old-notes': {
        'task': 'notes.tasks.delete_notes_older_than_four_hours',
        'schedule': timedelta(hours=4),  # Adjust the schedule as per your requirement
    },
}
